...
//! Project version number for ESRC_Heart_SDK_iOS.
FOUNDATION_EXPORT double ESRC_Heart_SDK_iOSVersionNumber;

//! Project version string for ESRC_Heart_SDK_iOS.
